...
import { ApiResponse, Task } from '../types/index.js';
...
export const taskController = {
  async getTasks(req: Request, res: Response<ApiResponse<Task[]>>): Promise<void> {
  ...
  async deleteTask(req: Request, res: Response<ApiResponse<{ id: string }>>): Promise<void> {
    const id = Array.isArray(req.params.id) ? req.params.id[0] : req.params.id;
